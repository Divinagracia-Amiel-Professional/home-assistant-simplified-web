import { Column, ButtonCard, Row } from '@hakit/components';
...
const switchID = {
  AC: 'switch.esphometest_1_switch2',
  Efan: 'switch.esphometest_1_switch1',
  Monitor: 'switch.esphometest_2_switch2',
  PC: 'switch.esphometest_2_switch1',
};

const CustomSwitches = () => {
  const ACSwitch = useEntity(switchID.AC);
  const EFanSwitch = useEntity(switchID.Efan);
  const MonitorSwitch = useEntity(switchID.Monitor);
  const DesktopSwitch = useEntity(switchID.PC);

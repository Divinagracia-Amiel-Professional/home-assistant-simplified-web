...
import { ACEnergy, PCEnergy, MonitorEnergy, EFanEnergy } from '../../assets/sensorData/sensorDataIndex.js';
...
dataArray.forEach(d => {
  promises.push(
    admin
      .firestore()
      .collection('users')
      .doc('8a5552df72bb418283c3a61853a5bf93')
      .collection('devices')
      .doc('eprP3QlOyrzE9RPnqjv2')
      .collection('energy')
      .add(d)
  );
});
